...
import { ArrowDown, ArrowUp, Copy, ExternalLink, Loader2, Maximize2, Music2, Play, RotateCcw, Settings2, Sparkles } from "lucide-react";
...
export default function Home() {
  ...
  const activeTitle = fetchSong.data?.title?.replace(/^אקורדים לשיר\s*/i, "") || "להתאפק"; const activeArtist = fetchSong.data?.artist || "מרסדס בנד";
